        ...
        <div class="container my-3">
            <div class="card" style="background-color: #f0f0f0; border-radius: 10px;">
                ...
                <hr>
                    ...
                    $harga = ($customPanjang * $customLebar) * $hargaa;
                    ?>
                ...
                <div id="myCarousel" class="carousel slide mt-4" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators">
                        ...
                        foreach ($images as $index => $image) {
                            $image_array = explode(',', $image->foto_c);
                                ...
                                foreach ($image_array as $img) {
                                    if (!empty(trim($img))) {
                                        ...
                                        <div class="carousel-item <?php echo $is_first ? 'active' : ''; ?>">
                                            <img src="<?php echo base_url('assets/foto_barang/' . trim($img)); ?>" class="d-block w-100"
                                                alt="Slide <?php echo $total_images + 1; ?>"
