                        ...
                        <div class='row'>
                            <div class='col-md-9'>
                                <div style="padding-bottom: 10px;">
                                    <?php echo anchor(site_url('tbl_foto_murah/create'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Update Foto Rumah', 'class="btn btn-danger btn-sm"'); ?>
                                    <?php echo anchor(site_url('tbl_foto_murah/create_denah'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Update Foto Denah', 'class="btn btn-info btn-sm"'); ?>
                                </div>
                            </div>
                            <div class='col-md-3'>
                                <form action="<?php echo site_url('tbl_murah/index'); ?>" class="form-inline"
                                    method="get">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            ...
                                            if ($q <> '') {
                                                ?>
                                                <a href="<?php echo site_url('tbl_murah'); ?>"
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center" width="200px">
                                        ...
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#myModal<?php echo $tbl_murah->id_murah ?>">Lihat Foto
                                            Rumah</button>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#myModalDenah<?php echo $tbl_murah->id_murah ?>">Lihat Foto
                                            Denah</button>
                                    </td>
                                </tr>
                                <?php
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $foto = $this->Tbl_murah_model->get_by_id($tbl_murah->id_murah);
                            if ($foto && $foto->foto != null) {
                                ...
                                foreach ($photos as $photo):
                                    ...
                                    <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><img src="<?php echo base_url('assets/foto_murah/' . htmlspecialchars((string) $photo)) ?>"
                                                width="150px"></td>
                                        <td>
                                            <!-- Form for delete action -->
                                            <form action="<?php echo site_url('Tbl_foto_murah/delete_photo'); ?>" method="post">
                                                <input type="hidden" name="photo_url"
                                                    value="<?php echo htmlspecialchars((string) $photo); ?>">
                                                <input type="hidden" name="id_murah"
                                                    value="<?php echo $foto->id_murah; ?>">
...
<!-- Modal -->
<?php foreach ($tbl_murah_data as $tbl_murah): ?>
    <div id="myModalDenah<?php echo $tbl_murah->id_murah ?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- konten modal-->
            <div class="modal-content">
                <!-- heading modal -->
                            ...
                            if ($foto && $foto->foto_denah != null) {
                                ...
                                foreach ($photos as $photo):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Form for delete action -->
                                            <form action="<?php echo site_url('Tbl_foto_murah/delete_photo_denah'); ?>" method="post">
                                                <input type="hidden" name="photo_url"
                                                    value="<?php echo htmlspecialchars((string) $photo); ?>">
                                                <input type="hidden" name="id_murah"
                                                    value="<?php echo $foto->id_murah; ?>">
