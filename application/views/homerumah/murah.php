                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url('homerumah/ukuran_murah') ?>" method="get" enctype="multipart/form-data" autocomplete="off">
                            <div class="radio-button mb-3">
                                ...
                                <input type="radio" id="radio<?php echo $row->id_murah?>" name="tipe_rumah" value="<?php echo $row->id_murah?>" required>
                                <label for="radio<?php echo $row->id_murah?>"><?php echo $row->tipe?></label>
                                <?php endforeach; ?>
                            </div>
