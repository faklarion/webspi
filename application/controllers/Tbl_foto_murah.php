...
class Tbl_foto_murah extends CI_Controller
{
    ...
    public function create_denah() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('tbl_foto_murah/create_denah_action'),
            'id_foto' => set_value('id_foto'),
            'id_murah' => set_value('id_murah'),
            'foto' => set_value('foto'),
	);
    ...
    public function create_action() 
    {
        ...
        $this->load->database();
        $query = $this->db->get_where('tbl_murah', ['id_murah' => $this->input->post('id_murah')]);
        $data = $query->row();
        ...
        $this->db->where('id_murah', $this->input->post('id_murah'));
        $this->db->update('tbl_murah', $update_data);
    ...
    public function delete_photo_denah() {
        ...
        $id = $this->input->post('id_murah');
    
        // Perform deletion logic (update your database accordingly)
        // Example: Delete from database
        $success = $this->Tbl_murah_model->delete_photo_by_url($id, $photo_url);
    ...
    public function delete_photo() {
        ...
        // Perform deletion logic (update your database accordingly)
        // Example: Delete from database
        $success = $this->Tbl_murah_model->delete_photo_rumah_by_url($id, $photo_url);
