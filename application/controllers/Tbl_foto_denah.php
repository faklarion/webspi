...
class Tbl_foto_denah extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $tbl_foto_denah = $this->Tbl_foto_denah_model->get_limit_data($config['per_page'], $start, $q);
    ...
    public function create_action() 
    {
        ...
        $update_data = [
            'foto' => $images_string,
            'ukuran_awal' => $this->input->post('ukuran_awal'),
            'ukuran_akhir' => $this->input->post('ukuran_akhir'),
            // Tambahkan field lain yang perlu diupdate
        ];

        $this->Tbl_foto_denah_model->insert($update_data);
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->update($this->input->post('id_foto_denah', TRUE));
        } else {
            $data = array(
		...
		'ukuran_awal' => $this->input->post('ukuran_awal',TRUE),
            ...
            $this->Tbl_foto_denah_model->update($this->input->post('id_foto_denah', TRUE), $data);
